// @deno-types="https://deno.land/x/source_map@0.7.3/source-map.d.ts"
export * as mozilla from "https://deno.land/x/source_map@0.7.3/mod.js";

export type {
  RawSourceMap,
  SourceMapConsumer,
  SourceMapGenerator,
} from "https://deno.land/x/source_map@0.7.3/source-map.d.ts";
