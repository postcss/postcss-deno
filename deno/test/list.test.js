...
it("space() works from variable", () => {
  ...
  expect(space("a b")).toEqual([
    "a",
    "b",
  ]);
});
it("comma() splits list by spaces", () => {
  expect(list.comma("a, b")).toEqual([
    "a",
    "b",
  ]);
});
